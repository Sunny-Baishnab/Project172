...
AFRAME.registerComponent("markerhandler", {
  ...
  askUserId: function() {
    var iconUrl ="https://raw.githubusercontent.com/Sunny-Baishnab/toy-store-assets/main/attachment_120988766.jpg"
  ...
  getOrderSummary: async function (id) {
    return await firebase
      .firestore()
      .collection("users")
      .doc(id)
  ...
  handleOrderSummary: async function () {
    ...
    var id;
    uid <= 9 ? (id = `T0${uid}`) : `T${uid}`;

    //Getting Order Summary from database
    var orderSummary = await this.getOrderSummary(id);
